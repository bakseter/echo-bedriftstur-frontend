        ...
        div [ class "hjem" ]
            [ div [ class "hjem-content" ]
                [ div [ class "text" ]
                    ...
                    , br [] []
                    , div [] [ text "Registrering åpner 23. mars kl. 12:00. Da kan du registrere deg med din studentmail, og fylle inn din kontaktinformasjon. Dette gjør det lettere og raskere for deg å melde deg på når påmeldingen kommer ut, fordi all informasjonen din allerede er fylt inn." ]
                    , br [] []
...
update msg model =
    case msg of
        ...
        AnimateHeader anim ->
            ...
            in ({ model | headerStyle = newHeaderStyle }, headerCmds)
