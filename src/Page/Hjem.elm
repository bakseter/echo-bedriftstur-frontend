...
view =
    row []
        [ textColumn [ centerX, spacing 50, paddingEach { edges | bottom = 100, top = 50 } ]
            [ el [ Font.bold, Font.size 38 ] <| text "echo bedriftstur 2021"
        ...
        , column [ Background.color Theme.blue1, width fill, height fill ]
            [ text "asd" ]
        ]
