		...
		switch (msg.$) {
			...
			case 'Fade':
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			default:
				return (!model.nav) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{nav: true}),
...
var $author$project$Main$LoadNav = {$: 'LoadNav'};
...
var $author$project$Main$getBedrifter = function (hide) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				hide ? $elm$html$Html$Attributes$class('hidden') : $elm$html$Html$Attributes$class('logos')
			]),
		_List_fromArray(
			[
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('fas fa-hourglass-start')
									]),
								_List_Nil)
							]))
					])),
...
var $author$project$Main$getHjem = F2(
	function (model, hide) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
...
var $author$project$Main$getOm = function (hide) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				hide ? $elm$html$Html$Attributes$class('hidden') : $elm$html$Html$Attributes$class('om')
			]),
		_List_fromArray(
			[
				A2(
...
var $author$project$Main$getProgram = function (hide) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				hide ? $elm$html$Html$Attributes$class('hidden') : $elm$html$Html$Attributes$class('program')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Kommer snart!')
					]))
			]));
};
	...
	switch (_v0.$) {
		case 'Hjem':
			return _Utils_ap(
				_List_fromArray(
					[
						A2($author$project$Main$getHjem, model, false)
					]),
				_Utils_ap(
					_List_fromArray(
						[
							$author$project$Main$getProgram(true)
						]),
					_Utils_ap(
						_List_fromArray(
							[
								$author$project$Main$getBedrifter(true)
							]),
						_List_fromArray(
							[
								$author$project$Main$getOm(true)
							]))));
		case 'Program':
			return _Utils_ap(
				_List_fromArray(
					[
						A2($author$project$Main$getHjem, model, true)
					]),
				_Utils_ap(
					_List_fromArray(
						[
							$author$project$Main$getProgram(false)
						]),
					_Utils_ap(
						_List_fromArray(
							[
			...
			return _Utils_ap(
				...
				_Utils_ap(
					...
					_Utils_ap(
						_List_fromArray(
							[
								$author$project$Main$getBedrifter(false)
							]),
						_List_fromArray(
							[
								$author$project$Main$getOm(true)
			...
			return _Utils_ap(
				...
				_Utils_ap(
					...
					_Utils_ap(
						...
						_List_fromArray(
							[
								$author$project$Main$getOm(false)
							]))));
	}
};
...
var $author$project$Main$loadNav = function (model) {
	var _v0 = model.nav;
	if (_v0) {
		return A2(
			$elm$html$Html$div,
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Events$onClick($author$project$Main$LoadNav)
						]),
					_List_fromArray(
						[
			...
			[
				...
				_List_fromArray(
					[
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$id('navBtn'),
												$elm$html$Html$Events$onClick($author$project$Main$LoadNav)
											]),
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$id('navBtn-icon'),
														$elm$html$Html$Attributes$class('fas fa-bars')
													]),
												_List_Nil)
											]))
									])),
						...
						$author$project$Main$loadNav(model),
						A2(
						$elm$html$Html$div,
						_List_Nil,
